...
var FilterPipeModule = /** @class */ (function () {
    ...
    FilterPipeModule_1 = FilterPipeModule;
    FilterPipeModule.forRoot = function () {
        return {
            ngModule: FilterPipeModule_1,
        };
    };
    var FilterPipeModule_1;
    FilterPipeModule = FilterPipeModule_1 = __decorate([
        NgModule({
            imports: [],
            declarations: [
                FilterPipe
